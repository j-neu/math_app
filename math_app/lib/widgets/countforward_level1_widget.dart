...
class _CountForwardLevel1WidgetState extends State<CountForwardLevel1Widget> {
  ...
  static const int requiredProblems = 3;
  ...
  void _generateNewProblem() {
    setState(() {
      // Generate a random starting point and sequence length (5-10 steps)
      final sequenceLength = 5 + _random.nextInt(6); // 5-10 steps
      ...
      _feedbackMessage = 'Tap the numbers in order from $_startNumber to $_targetNumber';
      _showSuccess = false;
      _isComplete = false;
    });
  }
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Notice how the numbers 10 and 20 are highlighted? '
                    'These are special "decade" numbers!',
