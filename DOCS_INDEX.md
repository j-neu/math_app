...
- [docs/clean-room/02-blueprint.md](docs/clean-room/02-blueprint.md) — 🟢 Two-tier blueprint: 59 core + deep-dive items, sequencing, break-off rules.
- [math_app/Research/diagnostic_core_v1.csv](math_app/Research/diagnostic_core_v1.csv) — 🟢 The **runtime** diagnostic (59 core items; 60 until A1.5-01 was struck by the R2.9 review). Generated by `scripts/generate_diagnostic_csv.py`. Sibling `diagnostic_deepdive_v1.csv` (32 items). Supersedes the legacy 92-question CSV (archived to `_sources_private/` 2026-08-29, `tasks.md` R5.1).
